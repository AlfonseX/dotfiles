...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/lightline.vim/,~/.vim/plugged/vim-eunuch/,~/.vim/plugged/vim-commentary/,~/.vim/plugged/vim-surround/,~/.vim/plugged/vim-easy-align/,~/.vim/plugged/tagbar/,~/.vim/plugged/gruvbox/,~/.vim/plugged/badwolf/,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vim80/pack/dist/opt/matchit,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=9
set shiftwidth=4
set showbreak=↪\ 
set showmatch
...
badd +8 mapping.vim
badd +1 mappings.txt
badd +36 plugged/lightline.vim/autoload/lightline/colorscheme/molokai.vim
badd +19 plugged/lightline.vim/autoload/lightline/colorscheme/popol.vim
badd +1 new
argglobal
silent! argdel *
$argadd ~/.vimrc
...
let s:l = 40 - ((13 * winheight(0) + 15) / 31)
